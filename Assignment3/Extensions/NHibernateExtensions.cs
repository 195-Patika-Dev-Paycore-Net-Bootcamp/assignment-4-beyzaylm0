...
namespace Assignment3.Extensions

{
    public static class NHibernateExtensions
    {
        public static IServiceCollection AddNHibernatePosgreSql(this IServiceCollection services, string connectionString)
        {
            ...
            services.AddScoped<IMapperSessionVehicle, MapperSessionVehicle>();
            services.AddScoped<IMapperSessionContainer, MapperSessionContainer>();
